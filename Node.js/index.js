...
app.get('/', async (req, res) => {
    try {
        ...
        const response = await axios.get(`https://jsonplaceholder.typicode.com/${resource}`); // Perbaikan di sini
...
// Menjalankan server
app.listen(port, () => {
    console.log(`Server berjalan di http://localhost:${port}`); // Perbaikan di sini
});
